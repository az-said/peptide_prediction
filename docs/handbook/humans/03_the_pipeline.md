...
The precompute script bypasses this entirely (`force_recompute=True`) because it IS the cache source-of-truth — see [ISSUE-034 fix](https://github.com/az-said/peptide_prediction/blob/main/docs/active/KNOWN_ISSUES.md).
