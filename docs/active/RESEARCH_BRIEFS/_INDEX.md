...
|---|---|---|---|---|---|
| [RB-VALIDATION-V0-1](RB-VALIDATION-V0-1.md) | 2026-05-21 | PVL classifier validation vs Staphylococcus 2023 (TEM Fibrils) — false-positive class analysis + 13-canary CI suite (T5 dispatch 2026-05-20) | DRAFT — companion canary test landed; awaiting Said sign-off on §6 disclosure paragraph + Peleg review on AMP-FP framing | FF-Helix sens=1.000 / spec=0.000 (n=66); 17/18 FPs are PSM-α2 AMP class. Ship UI disclosure + canary CI. **DO NOT** retune thresholds — no cutoff improves F1 above 0.385 on labeled subset. | `ui/src/pages/Help.tsx` (disclosure paragraph), `backend/tests/test_canary_peptides.py` (LANDED 13 tests, all green), JOSS supplement |
| [RB-005](RB-005_workflow-and-ai-platform-deep.md) | 2026-05-12 | Workflow excellence + AI-platform power — deep Tier 2 mission (T5-DEEP-001) | DRAFT — awaiting Said review of §6 + §11 questions; G2 architecture proposed as ADR-020 | Workflow top-4 (SessionEnd changelog, 🧪 test gate, /wake, AGENTS.md import) + G2 top-4 (PaperQA2-pattern agentic RAG, 5-rule hallucination guard, Blablador opt-in, ExplainPanel UI) | ADR-020 PROPOSED, ROADMAP Wave 0.4 + Wave 3, MASTER_PUSH_PLAN Wave 3 detail |
| [RB-004](RB-004_ai-workflow-infrastructure.md) | 2026-05-12 | AI-native dev workflow for solo OSS scientific founder — hooks, Cowork, multi-terminal, collab, rituals (M-006) — Tier 1 baseline | PARTIAL SHIPPED (commit `60c5a96`: Stop+test hook + AGENTS.md + ADR-018/019). Remaining items addressed/superseded by RB-005. | Top 5: Stop+test hook · PRE-FLIGHT v2 + Cursor rule · AGENTS.md + TERMINAL_STATUS · TS typecheck + npm guard · COLLAB.md + changelog-peleg | ADR-018 ACCEPTED, ADR-019 ACCEPTED, ROADMAP Wave 0.3 shipped |
